			...
			<div class="container">				
				...
				<div class="pad group">
					...
					<div class="grid one-half">
						...
						<div id="credit">
							<p><?php esc_html_e('Powered by','enspire'); ?> <a href="<?php echo esc_url( 'http://wordpress.org' ); ?>" rel="nofollow">WordPress</a>. <?php esc_html_e('Theme by','enspire'); ?> <a href="http://alxmedia.se" rel="nofollow">Alx</a>.</p>
						</div><!--/#credit-->
						<?php endif; ?>
