...
if ( ! function_exists( 'alx_load' ) ) {
	...
	function alx_load() {
		...
		load_theme_textdomain( 'enspire', get_template_directory().'/languages' );
...
if ( ! function_exists( 'alx_setup' ) ) {
	...
	function alx_setup() {		
		...
		add_image_size( 'thumb-square', 320, 320, true );
...
if ( ! function_exists( 'alx_sidebars' ) ) {
	...
	function alx_sidebars()	{
		...
		if ( ot_get_option('header-ads') == 'on' ) { register_sidebar(array( 'name' => 'Header Ads','id' => 'header-ads', 'description' => "Header ads area", 'before_widget' => '<div id="%1$s" class="widget %2$s">','after_widget' => '</div>','before_title' => '<h3 class="group"><span>','after_title' => '</span></h3>')); }
