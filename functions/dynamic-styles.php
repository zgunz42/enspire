...
if ( ! function_exists( 'alx_dynamic_css' ) ) {
	...
	function alx_dynamic_css() {
		if ( ot_get_option('dynamic-styles') != 'off' ) {
			...
			// primary color
			if ( ot_get_option('color-1') != '#1db954' ) {
				$styles .= '
...
.wp-pagenavi span.current { border-bottom-color: '.ot_get_option('color-1').'!important; }					
			...
			// logo background
			if ( ot_get_option('color-logo') != '#1db954' ) {
				$styles .= '.site-title a  { background-color: '.ot_get_option('color-logo').'; } '."\n";
			}
			// comments bubble color
			if ( ot_get_option('color-bubble') != '#1db954' ) {
				$styles .= '
.post-comments,
.page-title .meta-single li.comments a  { background-color: '.ot_get_option('color-bubble').'; }
...
.page-title .meta-single li.comments a:before { border-right-color: '.ot_get_option('color-bubble').'; border-top-color: '.ot_get_option('color-bubble').'; }				
			...
			// footer color
			if ( ot_get_option('color-footer') != '#1db954' ) {
