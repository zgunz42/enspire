...
if ( ! function_exists( 'alx_dynamic_css' ) ) {
	...
	function alx_dynamic_css() {
		if ( get_theme_mod('dynamic-styles', 'on') == 'on' ) {
			...
			// primary color
			if ( get_theme_mod('color-1','#1db954') != '#1db954' ) {
				$styles .= '
...
.wp-pagenavi span.current { border-bottom-color: '.get_theme_mod('color-1').'!important; }					
			...
			// logo background
			if ( get_theme_mod('color-logo','#1db954') != '#1db954' ) {
				$styles .= '.site-title a  { background-color: '.get_theme_mod('color-logo').'; } '."\n";
			}
			// comments bubble color
			if ( get_theme_mod('color-bubble','#1db954') != '#1db954' ) {
				$styles .= '
.post-comments,
.page-title .meta-single li.comments a  { background-color: '.get_theme_mod('color-bubble').'; }
...
.page-title .meta-single li.comments a:before { border-right-color: '.get_theme_mod('color-bubble').'; border-top-color: '.get_theme_mod('color-bubble').'; }				
			...
			// footer color
			if ( get_theme_mod('color-footer','#1db954') != '#1db954' ) {
