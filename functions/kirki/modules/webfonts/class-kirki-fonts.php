...
final class Kirki_Fonts {
	...
	public static function get_all_variants() {
		return array(
			'100'       => esc_attr__( 'Ultra-Light 100', 'enspire' ),
			'100light'  => esc_attr__( 'Ultra-Light 100', 'enspire' ),
			'100italic' => esc_attr__( 'Ultra-Light 100 Italic', 'enspire' ),
			'200'       => esc_attr__( 'Light 200', 'enspire' ),
			'200italic' => esc_attr__( 'Light 200 Italic', 'enspire' ),
			'300'       => esc_attr__( 'Book 300', 'enspire' ),
			'300italic' => esc_attr__( 'Book 300 Italic', 'enspire' ),
			'400'       => esc_attr__( 'Normal 400', 'enspire' ),
			'regular'   => esc_attr__( 'Normal 400', 'enspire' ),
			'italic'    => esc_attr__( 'Normal 400 Italic', 'enspire' ),
			'500'       => esc_attr__( 'Medium 500', 'enspire' ),
			'500italic' => esc_attr__( 'Medium 500 Italic', 'enspire' ),
			'600'       => esc_attr__( 'Semi-Bold 600', 'enspire' ),
			'600bold'   => esc_attr__( 'Semi-Bold 600', 'enspire' ),
			'600italic' => esc_attr__( 'Semi-Bold 600 Italic', 'enspire' ),
			'700'       => esc_attr__( 'Bold 700', 'enspire' ),
			'700italic' => esc_attr__( 'Bold 700 Italic', 'enspire' ),
			'800'       => esc_attr__( 'Extra-Bold 800', 'enspire' ),
			'800bold'   => esc_attr__( 'Extra-Bold 800', 'enspire' ),
			'800italic' => esc_attr__( 'Extra-Bold 800 Italic', 'enspire' ),
			'900'       => esc_attr__( 'Ultra-Bold 900', 'enspire' ),
			'900bold'   => esc_attr__( 'Ultra-Bold 900', 'enspire' ),
			'900italic' => esc_attr__( 'Ultra-Bold 900 Italic', 'enspire' ),
		);
	}
